...
namespace HMS
{
    public partial class UserControl12 : UserControl
    {
        public UserControl12()
        {
            ...
            ccd.Connection = conn;
            ccd.CommandText = "select name, patient_id from patient_info where discharge_date is not null";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "Insert into patient_bill(patient_id, store_charge) values(:patient_id, :store_charge)";

                cmd.Parameters.Add(new OracleParameter(":patient_id", comboBox1.SelectedValue));
                cmd.Parameters.Add(new OracleParameter(":store_charge", textBox1.Text));
